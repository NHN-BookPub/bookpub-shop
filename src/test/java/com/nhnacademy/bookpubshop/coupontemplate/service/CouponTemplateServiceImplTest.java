...
class CouponTemplateServiceImplTest {
    ...
    void setUp() {
        ...
        ReflectionTestUtils.setField(modifyRequestDto, "templateNo", 1L);
    ...
    void getDetailCouponTemplateTest_Success() {
        ...
        assertThat(result.getPricePrice()).isEqualTo(dto.getPricePrice());
        ...
        assertThat(result.getTemplateImage()).isEqualTo(dto.getTemplateImage());
        assertThat(result.getFinishedAt()).isEqualTo(dto.getFinishedAt());
        assertThat(result.getIssuedAt()).isEqualTo(dto.getIssuedAt());
        assertThat(result.isTemplateOverlapped()).isEqualTo(dto.isTemplateOverlapped());
    ...
    void getDetailCouponTemplatesTest_Success() {
        ...
        assertThat(content.get(0).getPricePrice()).isEqualTo(dto.getPricePrice());
    ...
    void getCouponTemplatesTest_Success() {
        GetCouponTemplateResponseDto dto =
                new GetCouponTemplateResponseDto("test_name", "test_image", LocalDateTime.now(), LocalDateTime.now());
