...
class CouponTemplateServiceImplTest {
    ...
    void createCouponTemplateTest_Success() throws IOException {
        ...
        File file = new File(null, null, null, null, null, null, null,
                "test_category", "test_path", "test_extension", "test_origin", "test_saved");
    ...
    void modifyCouponTemplateWithFile_Success() throws IOException {
        ...
        File storeFile = new File(null, null, null, null,
                null, null, null,"test_category", "test_path", "test_extention", "test_origin", "test_saved");
