...
==== 구독 수정
구독(Subscribe) 수정에대한 API 명세입니다.
===== 요청구조

include::../../../../target/snippets/subscribe-modify/http-request.adoc[]

===== 요청 파라미터들

include::../../../../target/snippets/subscribe-modify/request-parts.adoc[]

===== 응답 구조

include::../../../../target/snippets/subscribe-modify/http-response.adoc[]
